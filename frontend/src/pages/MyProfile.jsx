...

         {
          ...
          ? <label htmlFor="image">
              <div className=' inline-block relative cursor-pointer  '>
                ...
                <img className=' w-10 absolute bottum-12 right-12   ' src={image ? '' : assets.upload_icon } alt="" />
              </div>
     ...
     <div className='mt-10  ' >
      {
        isEdit
        ?
        <button className='border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transition-all' onClick={updateUserProfileData}>Save Informetion</button>
        :
